...
type Transaction struct {
	...
	PostDate     null.String `boil:"post_date" json:"post_date,omitempty" toml:"post_date" yaml:"post_date,omitempty"`
	EnterDate    null.String `boil:"enter_date" json:"enter_date,omitempty" toml:"enter_date" yaml:"enter_date,omitempty"`
...
var TransactionTableColumns = struct {
	...
	CurrencyGUID: "transactions.currency_guid",
	Num:          "transactions.num",
	PostDate:     "transactions.post_date",
	EnterDate:    "transactions.enter_date",
...
var TransactionWhere = struct {
	...
	Num          whereHelperstring
	PostDate     whereHelpernull_String
	EnterDate    whereHelpernull_String
	Description  whereHelpernull_String
}{
	GUID:         whereHelperstring{field: "\"transactions\".\"guid\""},
	CurrencyGUID: whereHelperstring{field: "\"transactions\".\"currency_guid\""},
	Num:          whereHelperstring{field: "\"transactions\".\"num\""},
	PostDate:     whereHelpernull_String{field: "\"transactions\".\"post_date\""},
	EnterDate:    whereHelpernull_String{field: "\"transactions\".\"enter_date\""},
...
var (
	transactionAllColumns            = []string{"guid", "currency_guid", "num", "post_date", "enter_date", "description"}
	transactionColumnsWithoutDefault = []string{"guid", "currency_guid", "num"}
	transactionColumnsWithDefault    = []string{"post_date", "enter_date", "description"}
	transactionPrimaryKeyColumns     = []string{"guid"}
...
func (q transactionQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Transaction, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "gnucash: failed to execute a one query for transactions")
	}
...
func (q transactionQuery) All(ctx context.Context, exec boil.ContextExecutor) (TransactionSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "gnucash: failed to assign all query results to Transaction slice")
	}
...
func (q transactionQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "gnucash: failed to count transactions rows")
	}
...
func (q transactionQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "gnucash: failed to check if transactions exists")
	}
...
func FindTransaction(ctx context.Context, exec boil.ContextExecutor, gUID string, selectCols ...string) (*Transaction, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"transactions\" where \"guid\"=?", sel,
	)
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "gnucash: unable to select from transactions")
	}
...
func (o *Transaction) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("gnucash: no transactions provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "gnucash: unable to insert into transactions")
	}
...
func (o *Transaction) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("gnucash: unable to update transactions, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "gnucash: unable to update transactions row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "gnucash: failed to get rows affected by update for transactions")
	}
...
func (q transactionQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "gnucash: unable to update all for transactions")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "gnucash: unable to retrieve rows affected for transactions")
	}
...
func (o TransactionSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "gnucash: unable to update all in transaction slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "gnucash: unable to retrieve rows affected all in update all transaction")
	}
	return rowsAff, nil
}
...
func (o *Transaction) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("gnucash: no transactions provided for upsert")
	}
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("gnucash: unable to upsert transactions, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "gnucash: unable to upsert transactions")
	}
...
func (o *Transaction) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("gnucash: no Transaction provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "gnucash: unable to delete from transactions")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "gnucash: failed to get rows affected by delete for transactions")
	}
...
func (q transactionQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("gnucash: no transactionQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "gnucash: unable to delete all from transactions")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "gnucash: failed to get rows affected by deleteall for transactions")
	}
...
func (o TransactionSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "gnucash: unable to delete all from transaction slice")
	}
...
func (o *Transaction) Reload(ctx context.Context, exec boil.ContextExecutor) error {
	ret, err := FindTransaction(ctx, exec, o.GUID)
	if err != nil {
		return err
	}
...
func (o *TransactionSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "gnucash: unable to reload all in TransactionSlice")
	}
...
func TransactionExists(ctx context.Context, exec boil.ContextExecutor, gUID string) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"transactions\" where \"guid\"=? limit 1)"
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "gnucash: unable to check if transactions exists")
	}
...
func (o *Transaction) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	return TransactionExists(ctx, exec, o.GUID)
}
