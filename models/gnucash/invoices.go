...
type Invoice struct {
	...
	DateOpened     null.String `boil:"date_opened" json:"date_opened,omitempty" toml:"date_opened" yaml:"date_opened,omitempty"`
	DatePosted     null.String `boil:"date_posted" json:"date_posted,omitempty" toml:"date_posted" yaml:"date_posted,omitempty"`
	...
	BillingID      null.String `boil:"billing_id" json:"billing_id,omitempty" toml:"billing_id" yaml:"billing_id,omitempty"`
	PostTXN        null.String `boil:"post_txn" json:"post_txn,omitempty" toml:"post_txn" yaml:"post_txn,omitempty"`
	PostLot        null.String `boil:"post_lot" json:"post_lot,omitempty" toml:"post_lot" yaml:"post_lot,omitempty"`
	PostAcc        null.String `boil:"post_acc" json:"post_acc,omitempty" toml:"post_acc" yaml:"post_acc,omitempty"`
	...
	ChargeAmtNum   null.Int64  `boil:"charge_amt_num" json:"charge_amt_num,omitempty" toml:"charge_amt_num" yaml:"charge_amt_num,omitempty"`
	ChargeAmtDenom null.Int64  `boil:"charge_amt_denom" json:"charge_amt_denom,omitempty" toml:"charge_amt_denom" yaml:"charge_amt_denom,omitempty"`
...
var InvoiceColumns = struct {
	...
	ChargeAmtNum:   "charge_amt_num",
	ChargeAmtDenom: "charge_amt_denom",
}
...
var InvoiceTableColumns = struct {
	...
	GUID:           "invoices.guid",
	ID:             "invoices.id",
	DateOpened:     "invoices.date_opened",
	DatePosted:     "invoices.date_posted",
	Notes:          "invoices.notes",
	Active:         "invoices.active",
	Currency:       "invoices.currency",
	OwnerType:      "invoices.owner_type",
	OwnerGUID:      "invoices.owner_guid",
	Terms:          "invoices.terms",
	BillingID:      "invoices.billing_id",
	PostTXN:        "invoices.post_txn",
	PostLot:        "invoices.post_lot",
	PostAcc:        "invoices.post_acc",
	BilltoType:     "invoices.billto_type",
	BilltoGUID:     "invoices.billto_guid",
	ChargeAmtNum:   "invoices.charge_amt_num",
	ChargeAmtDenom: "invoices.charge_amt_denom",
}
...
var InvoiceWhere = struct {
	...
	DateOpened     whereHelpernull_String
	DatePosted     whereHelpernull_String
	...
	BillingID      whereHelpernull_String
	PostTXN        whereHelpernull_String
	PostLot        whereHelpernull_String
	PostAcc        whereHelpernull_String
	BilltoType     whereHelpernull_Int64
	BilltoGUID     whereHelpernull_String
	ChargeAmtNum   whereHelpernull_Int64
	ChargeAmtDenom whereHelpernull_Int64
}{
	GUID:           whereHelperstring{field: "\"invoices\".\"guid\""},
	ID:             whereHelperstring{field: "\"invoices\".\"id\""},
	DateOpened:     whereHelpernull_String{field: "\"invoices\".\"date_opened\""},
	DatePosted:     whereHelpernull_String{field: "\"invoices\".\"date_posted\""},
	Notes:          whereHelperstring{field: "\"invoices\".\"notes\""},
	Active:         whereHelperint64{field: "\"invoices\".\"active\""},
	Currency:       whereHelperstring{field: "\"invoices\".\"currency\""},
	OwnerType:      whereHelpernull_Int64{field: "\"invoices\".\"owner_type\""},
	OwnerGUID:      whereHelpernull_String{field: "\"invoices\".\"owner_guid\""},
	Terms:          whereHelpernull_String{field: "\"invoices\".\"terms\""},
	BillingID:      whereHelpernull_String{field: "\"invoices\".\"billing_id\""},
	PostTXN:        whereHelpernull_String{field: "\"invoices\".\"post_txn\""},
	PostLot:        whereHelpernull_String{field: "\"invoices\".\"post_lot\""},
	PostAcc:        whereHelpernull_String{field: "\"invoices\".\"post_acc\""},
	BilltoType:     whereHelpernull_Int64{field: "\"invoices\".\"billto_type\""},
	BilltoGUID:     whereHelpernull_String{field: "\"invoices\".\"billto_guid\""},
	ChargeAmtNum:   whereHelpernull_Int64{field: "\"invoices\".\"charge_amt_num\""},
	ChargeAmtDenom: whereHelpernull_Int64{field: "\"invoices\".\"charge_amt_denom\""},
}
...
var (
	invoiceAllColumns            = []string{"guid", "id", "date_opened", "date_posted", "notes", "active", "currency", "owner_type", "owner_guid", "terms", "billing_id", "post_txn", "post_lot", "post_acc", "billto_type", "billto_guid", "charge_amt_num", "charge_amt_denom"}
	invoiceColumnsWithoutDefault = []string{"guid", "id", "notes", "active", "currency"}
	invoiceColumnsWithDefault    = []string{"date_opened", "date_posted", "owner_type", "owner_guid", "terms", "billing_id", "post_txn", "post_lot", "post_acc", "billto_type", "billto_guid", "charge_amt_num", "charge_amt_denom"}
	invoicePrimaryKeyColumns     = []string{"guid"}
...
func (q invoiceQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Invoice, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "gnucash: failed to execute a one query for invoices")
	}
...
func (q invoiceQuery) All(ctx context.Context, exec boil.ContextExecutor) (InvoiceSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "gnucash: failed to assign all query results to Invoice slice")
	}
...
func (q invoiceQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "gnucash: failed to count invoices rows")
	}
...
func (q invoiceQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "gnucash: failed to check if invoices exists")
	}
...
func FindInvoice(ctx context.Context, exec boil.ContextExecutor, gUID string, selectCols ...string) (*Invoice, error) {
	invoiceObj := &Invoice{}
	...
	query := fmt.Sprintf(
		"select %s from \"invoices\" where \"guid\"=?", sel,
	)
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "gnucash: unable to select from invoices")
	}
...
func (o *Invoice) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("gnucash: no invoices provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "gnucash: unable to insert into invoices")
	}
...
func (o *Invoice) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("gnucash: unable to update invoices, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "gnucash: unable to update invoices row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "gnucash: failed to get rows affected by update for invoices")
	}
...
func (q invoiceQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "gnucash: unable to update all for invoices")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "gnucash: unable to retrieve rows affected for invoices")
	}
...
func (o InvoiceSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "gnucash: unable to update all in invoice slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "gnucash: unable to retrieve rows affected all in update all invoice")
	}
	return rowsAff, nil
}
...
func (o *Invoice) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("gnucash: no invoices provided for upsert")
	}
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("gnucash: unable to upsert invoices, could not build update column list")
		}
		...
		cache.query = buildUpsertQuerySQLite(dialect, "\"invoices\"", updateOnConflict, ret, update, conflict, insert)
	...
	if err != nil {
		return errors.Wrap(err, "gnucash: unable to upsert invoices")
	}
...
func (o *Invoice) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("gnucash: no Invoice provided for delete")
	}
	...
	sql := "DELETE FROM \"invoices\" WHERE \"guid\"=?"
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "gnucash: unable to delete from invoices")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "gnucash: failed to get rows affected by delete for invoices")
	}
...
func (q invoiceQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("gnucash: no invoiceQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "gnucash: unable to delete all from invoices")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "gnucash: failed to get rows affected by deleteall for invoices")
	}
...
func (o InvoiceSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "gnucash: unable to delete all from invoice slice")
	}
...
func (o *Invoice) Reload(ctx context.Context, exec boil.ContextExecutor) error {
	ret, err := FindInvoice(ctx, exec, o.GUID)
	if err != nil {
		return err
	}
...
func (o *InvoiceSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "gnucash: unable to reload all in InvoiceSlice")
	}
...
func InvoiceExists(ctx context.Context, exec boil.ContextExecutor, gUID string) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"invoices\" where \"guid\"=? limit 1)"
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "gnucash: unable to check if invoices exists")
	}
...
func (o *Invoice) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	return InvoiceExists(ctx, exec, o.GUID)
}
