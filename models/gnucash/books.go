...
type Book struct {
	...
	RootAccountGUID  string `boil:"root_account_guid" json:"root_account_guid" toml:"root_account_guid" yaml:"root_account_guid"`
	RootTemplateGUID string `boil:"root_template_guid" json:"root_template_guid" toml:"root_template_guid" yaml:"root_template_guid"`
...
var BookColumns = struct {
	...
	GUID:             "guid",
	RootAccountGUID:  "root_account_guid",
	RootTemplateGUID: "root_template_guid",
}
...
var BookTableColumns = struct {
	...
	GUID:             "books.guid",
	RootAccountGUID:  "books.root_account_guid",
	RootTemplateGUID: "books.root_template_guid",
}
...
var BookWhere = struct {
	...
	RootAccountGUID  whereHelperstring
	RootTemplateGUID whereHelperstring
}{
	GUID:             whereHelperstring{field: "\"books\".\"guid\""},
	RootAccountGUID:  whereHelperstring{field: "\"books\".\"root_account_guid\""},
	RootTemplateGUID: whereHelperstring{field: "\"books\".\"root_template_guid\""},
}
...
var (
	bookAllColumns            = []string{"guid", "root_account_guid", "root_template_guid"}
	bookColumnsWithoutDefault = []string{"guid", "root_account_guid", "root_template_guid"}
	bookColumnsWithDefault    = []string{}
	bookPrimaryKeyColumns     = []string{"guid"}
...
func (q bookQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Book, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "gnucash: failed to execute a one query for books")
	}
...
func (q bookQuery) All(ctx context.Context, exec boil.ContextExecutor) (BookSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "gnucash: failed to assign all query results to Book slice")
	}
...
func (q bookQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "gnucash: failed to count books rows")
	}
...
func (q bookQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "gnucash: failed to check if books exists")
	}
...
func FindBook(ctx context.Context, exec boil.ContextExecutor, gUID string, selectCols ...string) (*Book, error) {
	bookObj := &Book{}
	...
	query := fmt.Sprintf(
		"select %s from \"books\" where \"guid\"=?", sel,
	)
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "gnucash: unable to select from books")
	}
...
func (o *Book) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("gnucash: no books provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "gnucash: unable to insert into books")
	}
...
func (o *Book) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("gnucash: unable to update books, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "gnucash: unable to update books row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "gnucash: failed to get rows affected by update for books")
	}
...
func (q bookQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "gnucash: unable to update all for books")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "gnucash: unable to retrieve rows affected for books")
	}
...
func (o BookSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "gnucash: unable to update all in book slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "gnucash: unable to retrieve rows affected all in update all book")
	}
	return rowsAff, nil
}
...
func (o *Book) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("gnucash: no books provided for upsert")
	}
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("gnucash: unable to upsert books, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "gnucash: unable to upsert books")
	}
...
func (o *Book) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("gnucash: no Book provided for delete")
	}
	...
	sql := "DELETE FROM \"books\" WHERE \"guid\"=?"
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "gnucash: unable to delete from books")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "gnucash: failed to get rows affected by delete for books")
	}
...
func (q bookQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("gnucash: no bookQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "gnucash: unable to delete all from books")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "gnucash: failed to get rows affected by deleteall for books")
	}
...
func (o BookSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "gnucash: unable to delete all from book slice")
	}
...
func (o *Book) Reload(ctx context.Context, exec boil.ContextExecutor) error {
	ret, err := FindBook(ctx, exec, o.GUID)
	if err != nil {
		return err
	}
...
func (o *BookSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "gnucash: unable to reload all in BookSlice")
	}
...
func BookExists(ctx context.Context, exec boil.ContextExecutor, gUID string) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"books\" where \"guid\"=? limit 1)"
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "gnucash: unable to check if books exists")
	}
...
func (o *Book) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	return BookExists(ctx, exec, o.GUID)
}
