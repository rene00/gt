...
type Price struct {
	...
	CommodityGUID string      `boil:"commodity_guid" json:"commodity_guid" toml:"commodity_guid" yaml:"commodity_guid"`
...
var PriceTableColumns = struct {
	...
	GUID:          "prices.guid",
	CommodityGUID: "prices.commodity_guid",
	CurrencyGUID:  "prices.currency_guid",
	Date:          "prices.date",
	Source:        "prices.source",
	Type:          "prices.type",
	ValueNum:      "prices.value_num",
	ValueDenom:    "prices.value_denom",
}
...
var PriceWhere = struct {
	...
	CommodityGUID whereHelperstring
	CurrencyGUID  whereHelperstring
	...
	GUID:          whereHelperstring{field: "\"prices\".\"guid\""},
	CommodityGUID: whereHelperstring{field: "\"prices\".\"commodity_guid\""},
	CurrencyGUID:  whereHelperstring{field: "\"prices\".\"currency_guid\""},
	Date:          whereHelperstring{field: "\"prices\".\"date\""},
	Source:        whereHelpernull_String{field: "\"prices\".\"source\""},
	Type:          whereHelpernull_String{field: "\"prices\".\"type\""},
	ValueNum:      whereHelperint64{field: "\"prices\".\"value_num\""},
	ValueDenom:    whereHelperint64{field: "\"prices\".\"value_denom\""},
}
...
var (
	priceAllColumns            = []string{"guid", "commodity_guid", "currency_guid", "date", "source", "type", "value_num", "value_denom"}
	priceColumnsWithoutDefault = []string{"guid", "commodity_guid", "currency_guid", "date", "value_num", "value_denom"}
	priceColumnsWithDefault    = []string{"source", "type"}
	pricePrimaryKeyColumns     = []string{"guid"}
...
func (q priceQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Price, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "gnucash: failed to execute a one query for prices")
	}
...
func (q priceQuery) All(ctx context.Context, exec boil.ContextExecutor) (PriceSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "gnucash: failed to assign all query results to Price slice")
	}
...
func (q priceQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "gnucash: failed to count prices rows")
	}
...
func (q priceQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "gnucash: failed to check if prices exists")
	}
...
func FindPrice(ctx context.Context, exec boil.ContextExecutor, gUID string, selectCols ...string) (*Price, error) {
	priceObj := &Price{}
	...
	query := fmt.Sprintf(
		"select %s from \"prices\" where \"guid\"=?", sel,
	)
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "gnucash: unable to select from prices")
	}
...
func (o *Price) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("gnucash: no prices provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "gnucash: unable to insert into prices")
	}
...
func (o *Price) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("gnucash: unable to update prices, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "gnucash: unable to update prices row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "gnucash: failed to get rows affected by update for prices")
	}
...
func (q priceQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "gnucash: unable to update all for prices")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "gnucash: unable to retrieve rows affected for prices")
	}
...
func (o PriceSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "gnucash: unable to update all in price slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "gnucash: unable to retrieve rows affected all in update all price")
	}
	return rowsAff, nil
}
...
func (o *Price) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("gnucash: no prices provided for upsert")
	}
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("gnucash: unable to upsert prices, could not build update column list")
		}
		...
		cache.query = buildUpsertQuerySQLite(dialect, "\"prices\"", updateOnConflict, ret, update, conflict, insert)
	...
	if err != nil {
		return errors.Wrap(err, "gnucash: unable to upsert prices")
	}
...
func (o *Price) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("gnucash: no Price provided for delete")
	}
	...
	sql := "DELETE FROM \"prices\" WHERE \"guid\"=?"
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "gnucash: unable to delete from prices")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "gnucash: failed to get rows affected by delete for prices")
	}
...
func (q priceQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("gnucash: no priceQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "gnucash: unable to delete all from prices")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "gnucash: failed to get rows affected by deleteall for prices")
	}
...
func (o PriceSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "gnucash: unable to delete all from price slice")
	}
...
func (o *Price) Reload(ctx context.Context, exec boil.ContextExecutor) error {
	ret, err := FindPrice(ctx, exec, o.GUID)
	if err != nil {
		return err
	}
...
func (o *PriceSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "gnucash: unable to reload all in PriceSlice")
	}
...
func PriceExists(ctx context.Context, exec boil.ContextExecutor, gUID string) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"prices\" where \"guid\"=? limit 1)"
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "gnucash: unable to check if prices exists")
	}

	return exists, nil
}

// Exists checks if the Price row exists.
func (o *Price) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	return PriceExists(ctx, exec, o.GUID)
}
